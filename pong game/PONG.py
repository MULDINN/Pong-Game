...
class GameManager:
	...
	def run_game(self):
		...
		# Atualizando os objetos do jogo
...
# Objetos do Jogo
player = Player('Paddle_verde.png',screen_width - 20,screen_height/2,5)
opponent = Opponent('Paddle_verde.png',20,screen_width/2,5)
